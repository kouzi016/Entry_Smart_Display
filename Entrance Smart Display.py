...
l = {
    ...
    "山梨県": "190000", "長野県": "200000", "岐阜県": "210000", "静岡県": "220000", "愛知県": "230000", "三重県": "240000", "新潟県": "150000",
    "富山県": "160000", "石川県": "170000", "福井県": "180000", "滋賀県": "250000", "京都府": "260000", "大阪府": "270000", "兵庫県": "280000",
...
def w_update():
    global image, image2, canvas, jma_weather, file, canvas2, code, place
    place_input = entry_place.get()
    if place_input in l:
        code = l[place_input]
        place = place_input
...
weather = tk.Message(root, text=f"{place}の天気：{jma_weather}", font=("Yu Gothic UI", 20, "bold"), background="white", width=1000)
